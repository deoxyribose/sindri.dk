                ...
                <li key={person.name}>
                  <div className="space-y-4">
                    <div className="aspect-w-3 aspect-h-2 relative">
                      <img className="object-cover shadow-lg rounded-lg" loading="eager" layout="fill" src={person.imageUrl} alt="" />
                    </div>
                    ...
                    <ul role="list" className="flex space-x-5">
                      <li>
                        <a href={person.twitterUrl} className="text-gray-400 hover:text-gray-500">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokewidth="2" stroke-linecap="round" strokelinejoin="round" className="feather feather-twitter">
                      ...
                      <li>
                        <a href={person.linkedinUrl} className="text-gray-400 hover:text-gray-500">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokewidth="2" stroke-linecap="round" strokelinejoin="round" className="feather feather-linkedin">
                      ...
                      <li>
                        <a href={person.email} className="text-gray-400 hover:text-gray-500">
                          ...
                          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokewidth="2" stroke-linecap="round" strokelinejoin="round" className="feather feather-mail">
