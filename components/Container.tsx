...
export default function Container(props) {
  ...
  const router = useRouter()
  const meta = {
    title: "Sindri – Data analysis on demand",
    description: `We are two freelancers helping organisations make sense of their data.`,
    image: "",
    type: "website",
    ...customMeta,
  }
    ...
    <div className="bg-gray-50 dark:bg-gray-900">
      <div className="flex h-screen flex-col justify-between">
        <Head>
          ...
          <meta
            property="og:url"
            content={`https://sindri.dk${router.asPath}`}
          />
          <link rel="canonical" href={`https://sindri.dk${router.asPath}`} />
          <meta property="og:type" content={meta.type} />
          <meta property="og:site_name" content="sindri.dk" />
        ...
        <main
          id="skip"
          className="mb-auto flex flex-col justify-center bg-gray-50 px-8 dark:bg-gray-900"
        >
          {children}
        </main>
        <Footer />
